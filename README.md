...
Se toman todas las canciones de una playlist elegida y se ordenan según popularidad, a partir de esto se crea un cuadro de eliminación directa y se vá dando al usuario a elegir entre cada cruce de canciones.
Actualmente funciona todo por consola, proxima mejora crear toda una interfaz de usuario estétcia. Hace falta contar con `Client ID` para la API. 
